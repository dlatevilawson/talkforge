...
create table if not exists public.coach_memory (
  ...
  life_vision text not null default '',
  person_they_want_to_become text not null default '',
  compass_relationships text not null default '',
  compass_learning text not null default '',
  compass_health text not null default '',
  career_goals text[] not null default '{}',
  family_goals text[] not null default '{}',
  health_goals text[] not null default '{}',
  business_goals text[] not null default '{}',
  learning_goals text[] not null default '{}',
  life_milestones jsonb not null default '[]'::jsonb,
  commitments jsonb not null default '[]'::jsonb,
  last_vision_check_at timestamptz,
