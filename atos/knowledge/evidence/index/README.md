# D-EVID — Evidence Index

| Field | Value |
|---|---|
| **Domain ID** | D-EVID |
| **Document ID** | KNOW-EVID-INDEX |
| **Version** | 1.0.0 |
| **Status** | Active |
| **Authority** | KA-001 / KA-REORG-001 |
| **Owner** | Atlas / Research |

Indexed evidence packs. Full packets live in product evidence or this store; this index is the hop.

## Indexed packs

| Pack | Path | Domain | Confidence |
|---|---|---|---|
| CE-M1 Realtime Hello | [`../../../product/evidence/CE-M1-REALTIME-HELLO.md`](../../../product/evidence/CE-M1-REALTIME-HELLO.md) | D-ENGINE | Verified (PASS) |
| CE-M2 Stable Transcripts | [`../../../product/evidence/CE-M2-STABLE-TRANSCRIPTS.md`](../../../product/evidence/CE-M2-STABLE-TRANSCRIPTS.md) | D-ENGINE | Accepted (Engineering) |
| PPS-001 Progress | [`../../../product/evidence/PPS-001-PROGRESS.md`](../../../product/evidence/PPS-001-PROGRESS.md) | D-PROOF | Working (gated) |
