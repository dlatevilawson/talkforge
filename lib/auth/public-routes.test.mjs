...
describe("4B.13 proxy allowlist", () => {
  it("keeps /coach and AC session/turn public", () => {
  ...
  it("marks claim as auth-required at the API layer (not proxy HTML redirect)", () => {
    assert.equal(isAssistantCoachAuthPath("/api/assistant-coach/claim"), true);
    // Proxy does not HTML-redirect claim; route returns 401 JSON via requireApiUser.
