...
test("coach brain is restored — assessment does not strip Forge philosophy", () => {
  ...
  assert.match(system, /YOU \(Forge\) own/i);
  assert.match(system, /THE APP owns/i);
  assert.match(system, /observe.*persist|persists what it learns/i);
  assert.match(system, /master high-stakes real-world conversations/i);
