...
export function buildSystemInstructions(input?: {
  ...
  const excellenceRule = [
    ...
    "- Optional default when it fits: brief reflect then one useful prompt — Forge owns judgment (acknowledge / clarify / teach / challenge / pace).",
    "- Member speaks most of the time.",
