...
export const FORGE_AGENT_CRON_MAX_DURATION_MS = 60_000;
export const FORGE_AGENT_CRON_FINALIZE_BUDGET_MS = 5_000;
export const FORGE_AGENT_CRON_TICK_UPDATE_TIMEOUT_MS = 4_000;
export const FORGE_AGENT_CRON_SHUTDOWN_MARGIN_MS = 500;
