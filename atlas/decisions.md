...
Atlas should reference previous decisions before making recommendations.

Atlas should never invent decisions.
...
We are building the world's best place to practice communication.
...
Every feature must strengthen the mission.
...
Atlas exists to help execute the company's mission through stewardship, planning, and reasoning.
...
Every recommendation should be evaluated against constitutional principles.
...
2. **Phase 2 — “Narrow the context”:** Q1 **“Who are these conversations with?”** is multi-select from Manager/boss, Peer/colleague, Client/customer, Recruiter/HR, Business partner, Family/friend, Stranger/new contact. Q2 **“What trips you up most?”** is single-select from I freeze and don't know what to say, I ramble and lose the thread, I get emotional or defensive, I sound too harsh or aggressive, I cave as soon as they push back, I avoid the conversation entirely. Q3 **“When is this happening?”** is single-select from Today, This week, In the next 2 weeks, No specific deadline. CTA: **Diagnose**.
...
Atlas should reference this document before recommending changes to company direction.
