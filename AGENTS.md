...
| [HARDEN-005](atos/product/HARDEN-005-guest-migration-authorization.md) | Phase 7 guest migration authorization — **Milestone 7.1 approval gate** |
...
- **Guest migration authorization:** HARDEN-005 retires privileged cloud guest reassignment while preserving same-device local migration. Archive recovery is prohibited without a separate Founder-approved proof-of-possession checkpoint.
