...
- **Certification (EXEC-VERIFY-001):** Baseline remains **NO-GO** for general feature development. **Carve-out (Decision 060):** only the final Coach track may proceed via slices in [PHASE4B-AC-IMPLEMENTATION-SEQUENCE](atos/product/PHASE4B-AC-IMPLEMENTATION-SEQUENCE.md). Do not lift FREEZE-001 for held identity PRs. Do not treat this as a general feature GO.
...
- Do **not** ship new product features that are not documented, categorized, blind-spot reviewed, and roadmap-linked — except continuation of already-ratified tracks (e.g. CE-001 under RES-013; final Coach preview track under Decision 060 / IV-PROD-010).
